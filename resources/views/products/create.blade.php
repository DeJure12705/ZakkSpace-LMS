...
<body>
    ...
    <div class="container">
        ...
        <form action="#" method="POST">
            ...
            <input type="number" name="price" id="price" min="0" step="0.01" placeholder="Price">

            <label for="quantity">Quantity:</label>
            <input type="number" name="quantity" id="quantity" min="0" placeholder="Quantity" required>
